...
import { createEvent, getAllCategories } from "./apiAdmin";
  ...
  const showSuccess = () => (
    <div className="flex justify-center">
      ...
      >
        ...
        <p>{createdEvent} Event successfully created</p>
      </div>
    </div>
  );
  ...
  return (
    <>
      <div className="h-72 bg-gradient-to-r from-cyan-500 to-lightblue-500 ...">
        <div className="p-24">
          <h1 className="text-[#FDFDFD] text-4xl font-bold mt-10">Create an Event</h1>
          <h2 className="text-p">Add a new event</h2>
        </div>
      </div>
      <br />
      {isLoading()}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-2">
            ...
            >
              ...
              {/* <option value="6377818e4889a106dcd98bb8">Awards</option> */}
            </select>
          </div>
